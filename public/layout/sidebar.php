...
<aside class="sidebar">
    ...
    <div class="nav-section">
        ...
        <ul class="nav-list">
            <li class="nav-item">
                <a href="/Projects/study-tools-website/public/dashboard.php" 
        ...
        <ul class="nav-list">
            <li class="nav-item">
                <a href="/Projects/study-tools-website/public/todo.php" 
                   class="nav-link <?php echo $current_page === 'todo.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
            ...
            <li class="nav-item">
                <a href="/Projects/study-tools-website/public/pomodoro.php" 
                   class="nav-link <?php echo $current_page === 'pomodoro.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
            ...
            <li class="nav-item">
                <a href="/Projects/study-tools-website/public/habit.php" 
                   class="nav-link <?php echo $current_page === 'habit.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
            ...
            <li class="nav-item">
                <a href="/Projects/study-tools-website/public/flashcards.php" 
                   class="nav-link <?php echo $current_page === 'flashcards.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
    ...
    <div class="nav-section">
        ...
        <ul class="nav-list">
            <li class="nav-item">
                <a href="/Projects/study-tools-website/public/profile.php" 
            ...
            <li class="nav-item">
                <a href="/Projects/study-tools-website/public/settings.php" 
