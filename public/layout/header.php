...
<header class="header">
    <div class="header-content">
        <!-- Logo -->
        <a href="/Projects/study-tools-website/public/dashboard.php" class="logo">
        ...
        <div class="user-dropdown">
            ...
            <div class="user-menu">
                ...
                <a href="/Projects/study-tools-website/public/profile.php" class="user-menu-item">
                ...
                <a href="/Projects/study-tools-website/public/settings.php" class="user-menu-item">
                    <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
                ...
                <a href="/Projects/study-tools-website/public/auth/logout.php" class="user-menu-item text-error">
                    <svg class="nav-icon" viewBox="0 0 20 20" fill="none">
